...
export async function POST(req) {
  try {
    ...
    const prompt = `Based on a user's mood level of ${mood}/10 and energy level of ${energy}/10, 
      suggest 3 personalized activities that could help improve their mental well-being. 
      ...
      return NextResponse.json([
        {
          ...
          description: "Take deep, controlled breaths to center yourself and reduce stress.",
          duration: "5 minutes"
        },
        {
          title: "Quick Walk",
          description: "Take a brief walk to refresh your mind and boost energy.",
          duration: "10 minutes"
        },
        {
